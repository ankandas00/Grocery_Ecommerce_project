                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <div class="header__top__right">
                                            ...
                                            <div class="header__top__right__auth">
                                                <!-- <a href="USER/login.php"><i class="fa fa-user"></i> Login</a> -->
                                                <a  href="indexlogout.php"><i class="fa fa-user"></i> Logout</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="latest-prdouct__slider__item">
                                        <a href="#" class="latest-product__item">
                                            <div class="latest-product__item__pic">
                                                <img src="USER/student_img/<?php echo $row['pimage'];?>" alt="">
                                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            ...
                            <div class="product__item">
                                <div class="product__item__pic set-bg" data-setbg="USER/student_img/<?php echo $row['pimage']; ?>">
                                    <ul class="product__item__pic__hover">
                                        <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                        <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                        <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
