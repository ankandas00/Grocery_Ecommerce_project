...
$sel="SELECT product.*, categories.cname FROM product INNER JOIN categories ON product.cid=categories.cid";
$res=$con->query($sel);
  ...
  <table class="table">
    ...
    <tbody>
        ...
        <tr>
          ...
          <td><img style="width:100px;" src="student_img/<?php echo $row['pimage']; ?>"/></td>
          <td><?php echo $row['details']; ?></td>
  
          <td><a href="delete.php?did=<?php echo $row['pid']; ?>" class="btn btn-danger">Delete</a></td>
